...
namespace Imager
{
  ...
  struct Color
  {
    double padding; // Filler value for SIMD alignment
    double  red;
    double  green;
    double  blue;
    ...
    {
      // The following SIMD code relies on alignment of struct fields :/
    ...
    {
      __m256d a = _mm256_load_pd(&(this->padding));
      __m256d b = _mm256_broadcast_sd(&factor);
      a = _mm256_mul_pd(a,b);
    ...
    {
      __m256d a = _mm256_load_pd(&(this->padding));
      __m256d b = _mm256_broadcast_sd(&denom);
      a = _mm256_div_pd(a,b);
  ...
  {
    Color c;
    __m256d a = _mm256_load_pd(&(aColor.padding));
    __m256d b = _mm256_load_pd(&(bColor.padding));
    a = _mm256_mul_pd(a,b);
    _mm256_store_pd(&(c.padding), a);
    return c;
    /*return Color(
  ...
  {
    Color c;
    __m256d a = _mm256_load_pd(&(color.padding));
    __m256d b = _mm256_broadcast_sd(&scalar);
    a = _mm256_mul_pd(a,b);
    _mm256_store_pd(&(c.padding), a);
    return c;
  ...
  {
    Color c;
    __m256d aV = _mm256_load_pd(&(a.padding));
    __m256d bV = _mm256_load_pd(&(b.padding));
    aV = _mm256_add_pd(aV,bV);
    _mm256_store_pd(&(c.padding), aV);
    return c;
    /*return Color(
        a.red   + b.red,
        a.green + b.green,
